  ...
  nodes: [
    {
      ...
      type: "video",
      config: {
        src: "source/cmabempsi0000s92hv96qeixj/original.mp4",
        playbackRate: 1,
        trimStart: 0.55,
        trimEnd: 4.208008,
        muted: false,
    ...
    },
    {
      ...
      type: "video",
      config: {
        src: "source/cmabempsm0001s92h56fijyxz/original.mp4",
        playbackRate: 1,
    ...
    },
    {
      ...
      type: "video",
      config: {
        src: "source/cmabempsm0002s92hs4m25isx/original.mp4",
        playbackRate: 1,
        trimStart: 0,
        trimEnd: 3.625,
        muted: false,
    ...
    },
    {
      ...
      type: "video",
      config: {
        src: "source/cmabempsm0003s92hm3kzg61j/original.mp4",
        playbackRate: 1,
        trimStart: 0,
    ...
    {
      id: 91,
      start: 14.141016000000018,
      end: 18.474023999999986,
      type: "video",
      config: {
        src: "source/cmabempsn0005s92hxznsoqyi/original.mp4",
        playbackRate: 1,
        trimStart: 0,
        trimEnd: 4.3330079999999676,
        muted: false,
      },
      initialAttrs: {
        x: 240,
